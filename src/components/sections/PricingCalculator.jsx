              ...
              {featuresList.map((item) => {
                ...
                return (
                  <div
                    ...
                    className={`p-4 rounded-xl border cursor-pointer transition-all flex justify-between items-center ${isSelected ? '' : 'bg-[var(--surface-muted)] hover:bg-[var(--surface-primary)]'
                      }`}
                    style={featureStyles}
                  >
